...
const products: Product[] = [
  ...
  },
  {
    ...
    price: 770000,
    img: 'https://64.media.tumblr.com/c0a05728f9a56fd0e8ea2c0e2c2eb8c2/7262bb7b46839e52-a1/s1280x1920/8ab46431e509027b8e0fd4edfdd01d9f3ed870c4.jpg',
    description: 'Inspired by the legendary Lamborghini Miura of the 60s and with a German heart, it captivates with its pure lines. It is a mix of high technology and art. Carbon fiber chassis, components created with aluminum, titanium, avional and chromolybdenum alloys. All to create a jewel weighing only 1,280 kilos and with exceptional rigidity.',
  },
...
async function seed() {
  ...
  const user2: User = {
    ...
    name: 'Simina',
    surname: 'Ciui',
    address: 'Avenida de España, 13, 02002 Albacete, Spain',
